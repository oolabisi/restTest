...
class DroneSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Drone
        fields = ('url', 'name', 'drone_category', 'manufacturing_date', 'owner', 'has_it_competed',
                  'inserted_timestamp')
...
class PilotSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Pilot
        fields = ('url', 'name', 'gender', 'gender_description', 'race_count', 'inserted_timestamp', 'competitions')
